    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // detect a text .
//                detectTxt();
                Toast.makeText(Text_Recognition.this, "jgkdjg", Toast.LENGTH_LONG).show();
            }
        });
...
//                Toast.makeText(Text_Recognition.this, "Fail to detect the text from image..", Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
//
...
//            Toast.makeText(Text_Recognition.this, "No Text ", Toast.LENGTH_LONG).show();
//            return;
//        }
